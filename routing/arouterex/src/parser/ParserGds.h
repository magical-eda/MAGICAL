...
inline void PolygonLayer::scale(RealType scaleX, RealType scaleY)
{
...
class ParserGds
{
   ...
   private:
    ...
    private:
        ...
        std::vector<PolygonLayer> _activeRegions; ///< OD
};
...
namespace ExtractShapeLayerActionDetails
{
    ...
    inline IndexType layerIdx(IntType gdsLayer, std::vector<std::pair<IntType, IndexType>> &map)
    {
    ...
    inline void extractShape(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ObjectType *object)
    {
    }
    ...
    template<>
    inline void extractShape(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsRectangle *object)
    {
        DBG("Rect \n");
    ...
    template<>
    inline void extractShape(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsPolygon *object)
    {
    ...
    /// @brief process path
    template<>
    inline void extractShape(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsPath *object)
    {
...
namespace ExtractPoBlkActionDetails
{
    ...
    /// @brief default action
    template<typename ObjectType>
    inline void extractPoblk(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ObjectType *object)
    {
    }
    ...
    /// @brief process gds polygon
    template<>
    inline void extractPoblk(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsPolygon *object)
    {
    ...
    /// @brief process path
    template<>
    inline void extractPoblk(std::vector<std::pair<IntType, IndexType>> &map, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsPath *object)
    {
        auto polygon = object->toPolygon();
...
namespace ExtractActiveRegionActionDetails
{
    namespace gtl = boost::polygon;
    /// @brief default action
    template<typename ObjectType>
        inline void extractOD(IntType layer, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ObjectType *object)
        {
        }

    /// @brief process gds polygon
    template<>
        inline void extractOD(IntType layer, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsPolygon *object)
        {
    ...
    /// @brief process path
    template<>
        inline void extractOD(IntType layer, std::vector<PolygonLayer> &polygons, ::GdsParser::GdsRecords::EnumType type, ::GdsParser::GdsDB::GdsPath *object)
        {
            auto polygon = object->toPolygon();
            extractOD(layer, polygons, type, &polygon);
        }
}

struct ExtractActiveRegionAction
{
    /// @param first: the map between the gds layer indices to the router layers. Only care about the mapping within this map
    /// @param second: a reference to a vector of polygons, saved the read polygons in this vector
    ExtractActiveRegionAction(IntType layer, std::vector<PolygonLayer> &polygons) : _odLayer(layer), _polygons(polygons) {}
    template<typename ObjectType>
        void operator()(::GdsParser::GdsRecords::EnumType type, ObjectType* object)
        {
            ExtractActiveRegionActionDetails::extractOD(_odLayer, _polygons, type, object);
        }

    /// @return a message of action for debug
    std::string message() const 
    {
        return "ExtractActiveRegionAction";
    }

    IntType _odLayer; ///< OD layers
    std::vector<PolygonLayer> &_polygons; ///< The polygons read from the gds
};
