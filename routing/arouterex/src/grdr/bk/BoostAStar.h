...
inline IndexType BoostAStar::nodeKeyRelation(const BoostAStar::NodeKey &node1, const BoostAStar::NodeKey &node2)
{
...
inline const std::vector<BoostAStar::NodeKey> & BoostAStar::resultAlgo() 
{
    _result.clear();
...
inline BoostAStar::BoostAStar(IndexType xSize, IndexType ySize, IndexType zSize)
