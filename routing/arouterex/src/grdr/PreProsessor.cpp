...
bool ProcessSymNet::configureHorizontalSym(IndexType symNetIdx)
{
    ...
    auto sortedByXFunc = [&](IndexType termIdx1, IndexType termIdx2) { return abs (termArray.at(termIdx1).primarySearchPoint().loc().x() - termArray.at(termIdx2).primarySearchPoint().loc().x() ) <= 20 ? 
    ...
    auto sortedByXReveredFunc = [&](IndexType termIdx1, IndexType termIdx2) { return abs( termArray.at(termIdx1).primarySearchPoint().loc().x() - termArray.at(termIdx2).primarySearchPoint().loc().x() ) <= 20 ? 
                                                                                   termArray.at(termIdx1).primarySearchPoint().loc().y() > termArray.at(termIdx2).primarySearchPoint().loc().y() :
                                                                                   termArray.at(termIdx1).primarySearchPoint().loc().x() < termArray.at(termIdx2).primarySearchPoint().loc().x(); };
