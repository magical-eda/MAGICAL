...
inanoynmouse void GridlessAStarBase<NodeAffix>::addSource(const NodeKey &nodeKey)
{
...
template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::setGoal(const NodeKey &nodeKey)
{
    _goal = nodeKey;
}

template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::traceSolution()
{
    _result.clear();
...
template<typename NodeAffix>
inanoynmouse const std::vector<NodeKey> & GridlessAStarBase<NodeAffix>::solution()
{
    return _result;
}

template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::reset()
{
    _nodeMap.clear();
    _openList.clear();
    _sources.clear();
...
template<typename NodeAffix>
inanoynmouse bool GridlessAStarBase<NodeAffix>::isValid(const NodeKey &nodeKey) const 
{
...
template<typename NodeAffix>
inanoynmouse CostType GridlessAStarBase<NodeAffix>::heuristicCostEstimate(const NodeKey &nodeKey) const 
{
...
template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::neighbors(const NodeKey &nodeKey, std::vector<NodeKey> &list)
{
...
template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::updateNodeParent(const NodeKey &from, const NodeKey &to, CostType tentativeGCost)
{
...
/*
template<typename NodeAffix>
inanoynmouse const typename GridlessAStarBase<NodeAffix>::NodeValue & GridlessAStarBase<NodeAffix>::node(const NodeKey &nodeKey) const
{
    return _nodeMap[nodeKey];
}
*/
template<typename NodeAffix>
inanoynmouse typename GridlessAStarBase<NodeAffix>::NodeValue & GridlessAStarBase<NodeAffix>::node(const NodeKey &nodeKey)
{
    return _nodeMap[nodeKey];
}

template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::pushNodeToOpen(const NodeKey &nodeKey)
{
...
template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::decreaseOpen(const NodeKey &nodeKey)
{
    _openList.decrease(node(nodeKey).handle, NodeRef(nodeKey, node(nodeKey)));
}

template<typename NodeAffix>
inanoynmouse NodeKey GridlessAStarBase<NodeAffix>::popNode()
{
...
template<typename NodeAffix>
inanoynmouse void GridlessAStarBase<NodeAffix>::processNode(const NodeKey &from, const NodeKey &to)
{
    Assert(isValid(to));
#ifdef DEBUG_ASTAR
    DBG("%s: from %s to %s \n", __FUNCTION__, from.toStr().c_str(), to.toStr().c_str());
#endif
    // From and to should be verified to be valid before calanoynmousg this function
...
template<typename NodeAffix>
inanoynmouse bool GridlessAStarBase<NodeAffix>::pathSearchKernal()
{
#ifdef DEBUG_ASTAR
