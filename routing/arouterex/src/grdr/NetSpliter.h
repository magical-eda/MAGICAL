...
class NetSpliter
{
    public:
        ...
        /// Setters
        void setTerms(std::vector<Terminal> &pins) { _pinsPtr = &pins; }
        ...
        bool solveMST(const Database &db, bool selfSym = false);
    ...
    private:
        ...
        void reorder();
    private:
        std::vector<Terminal>* _pinsPtr = NULL; ///< Pointer to the pin vector/ problem input
