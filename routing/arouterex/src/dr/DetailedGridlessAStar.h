...
inline void NodeAffixDR::addVia(IndexType viaType)
{
    _viaType = viaType;
#if 0
...
class DetailedGridlessAStar : public GridlessAStarBase<NodeAffixDR>, public PathSearchAlgoAnaDR<NodeKey>
{
    ...
    /*------------------------------*/ 
        ...
        /// @brief consider routing only in the confident regions of the routing guide
        /// @param whether consider routing only in the confident regions of the routing guide
        void setOnlyRouteGuideConfident(bool onlyConfident) { _considerGuideConfident = onlyConfident; }
        ...
        void initRouteGuide(std::shared_ptr<RouteGuide> routeGuide) { _routeGuide = routeGuide; }
        /// @brief init active region, which is the interface to the active region
        /// @param the ptr to a ActiveRegion
        void initActiveRegion(std::shared_ptr<ActiveRegion> activeRegion) { _activeRegion = activeRegion; }
    ...
    protected:
        ...
        { 
            if (_routeGuide->hasGuide(_netIdx))
            {
                return 0;
            }
    ...
    private:
        ...
        /// @param second: the to node
        /// @return the history cost from "from" to "to"
        CostType guideCost(NodeKey from, NodeKey to) const;
        /*------------------------------*/ 
        /* Symmetry                      */
        /*------------------------------*/ 
    ...
    private:
        ...
        bool _considerGuideConfident = false; ///< Only route in the confident region of the route guide
        /*------------------------------*/ 
        ...
        std::shared_ptr<RouteGuide> _routeGuide; ///< Routing guide
        std::shared_ptr<ActiveRegion> _activeRegion; ///< Active region information
