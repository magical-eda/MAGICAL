...
inline const std::vector<ShapeConstructor::ShapeConstType> & ShapeConstructor::computeShape(ShapeID shapeID)
{
...
inline void ShapeConstructor::computeWire(ShapeID shapeID)
{
    _result.clear();
...
inline void ShapeConstructor::computeVIA(ShapeID shapeID)
{
    _result.clear();
    const auto &child = _db.drDB().netNode(shapeID);
    const auto &parent = _db.drDB().net(shapeID.netIdx).node(child.parent());
...
inline void ShapeConstructor::computeFixedShape(ShapeID shapeID)
{
    _result.clear();
...
inline Box<LocType> ShapeConstructor::computeWireShape(XY<LocType> from, XY<LocType> to, NetNodeWire wire) const 
{
...
inline Box<LocType> ShapeConstructor::computeViaBottomMetalShape(XY<LocType> loc, IndexType bottomLayer, NetNodeVIA via) const 
{
...
inline void ShapeConstructor::computeViaCutShape(ShapeID shapeID, std::vector<Box<LocType>> &resultList) const
{
    if (shapeID.isRouteShape())
    {
        const auto &child = _db.drDB().netNode(shapeID);
...
inline void ShapeConstructor::computeViaCutShape(XY<LocType> loc, IndexType bottomLayer, NetNodeVIA via, std::vector<Box<LocType>> &resultList) const 
{
...
inline Box<LocType> ShapeConstructor::computeViaTopMetalShape(XY<LocType> loc, IndexType bottomLayer, NetNodeVIA via) const
{
...
inline Box<LocType> ShapeConstructor::computeViaCutBBox(XY<LocType> loc, IndexType bottomLayer, NetNodeVIA via) const
{
...
inline bool ShapeConstructor::reachTerminal(ShapeID shapeID, XY<LocType> fromNode, IndexType fromRouteLayer, XY<LocType> toNode, IndexType toRouteLayer)
{
...
inline bool ShapeConstructor::onTrack(ShapeID shapeID, XY<LocType> fromNode, IndexType fromRouteLayer, XY<LocType> toNode, IndexType toRouteLayer)
{
...
inline bool ShapeConstructor::onTrackWire(ShapeID shapeID, XY<LocType> fromNode, IndexType fromRouteLayer, XY<LocType> toNode, IndexType toRouteLayer)
{
...
inline bool ShapeConstructor::onTrackVIA(ShapeID shapeID, XY<LocType> fromNode, IndexType fromRouteLayer, XY<LocType> toNode, IndexType toRouteLayer)
{
...
inline bool ShapeConstructor::rectInTerminal(ShapeID terminal, const Box<LocType> &rect, IndexType routeLayer)
{
    ...
    for (auto &terShape : _result)
    {
        ...
        {
            if (terShape.first.contain(rect))
            {
                return true;
            }
        }
