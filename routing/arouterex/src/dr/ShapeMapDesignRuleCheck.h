...
inline CheckResult ShapeMap::metalSpacingChecking(const Box<LocType> &lhs, const Box<LocType> &rhs, IndexType layer) const 
{
...
inline CheckResult ShapeMap::metalMinAreaChecking(const Box<LocType> &wireShape, IndexType layer) const 
{
    /// Minimum area check
