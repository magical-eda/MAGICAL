...
inline void SearchGraphConstructor::constructNetGraph(IndexType netIdx)
{
...
inline void SearchGraphConstructor::connectGRCell(const XYZ<IndexType> &grNodeFrom, const XYZ<IndexType> &grNodeTo)
{
...
inline NodeIdentifier SearchGraphConstructor::xyidx2Node(XY<IndexType> xyIdx, IndexType layer) const 
{
#ifndef USE_XYZ_NODEIDEN
...
inline XY<IndexType> SearchGraphConstructor::node2XYIdx(const NodeIdentifier &node) const
{
#ifndef USE_XYZ_NODEIDEN
...
inline XYZ<IndexType> SearchGraphConstructor::node2XYZIdx(const NodeIdentifier &node) const
{
#ifndef USE_XYZ_NODEIDEN
...
inline void SearchGraphConstructor::addGRGrid(const XYZ<IndexType> &grNode)
{
...
inline void SearchGraphConstructor::addInterLayerEdge(const XYZ<IndexType> &grNode, IndexType targetLayer)
{
...
inline void SearchGraphConstructor::addWestBoundaryEdge(const XYZ<IndexType> &grNode) 
{
...
inline void SearchGraphConstructor::addEastBoundaryEdge(const XYZ<IndexType> &grNode) 
{
...
inline void SearchGraphConstructor::addNorthBoundaryEdge(const XYZ<IndexType> &grNode) 
{
...
inline void SearchGraphConstructor::addSouthBoundaryEdge(const XYZ<IndexType> &grNode) 
{
    Assert(grNode.y() > 0);
...
inline std::string SearchGraphConstructor::node2Str(const NodeIdentifier &node)
{
    std::ostringstream oss;
#ifndef USE_XYZ_NODEIDEN
