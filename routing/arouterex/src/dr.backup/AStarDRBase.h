r/
// Created by anoynmous on 2018/08/21
//
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse const std::set<NodeIdentyType> & AStarDRBase<NodeIdentyType, NodeAffix>::neighbors(const NodeIdentyType &nodeIdenty) const 
{
    /*
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse void AStarDRBase<NodeIdentyType, NodeAffix>::updateNodeParent(const NodeIdentyType &from, const NodeIdentyType &to, IntType tentativeGCost)
{
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse void AStarDRBase<NodeIdentyType, NodeAffix>::reset()
{
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse void AStarDRBase<NodeIdentyType, NodeAffix>::retraceResult()
{
    _results.clear();
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse void AStarDRBase<NodeIdentyType, NodeAffix>::initAugListGraph(const std::map<NodeIdentyType, std::set<NodeIdentyType>> &listGraph)
{
    //Assert(0);
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse void AStarDRBase<NodeIdentyType, NodeAffix>::processNode(const NodeIdentyType &from, const NodeIdentyType &to)
{
#ifdef DEBUG_ASTAR
...
template<typename NodeIdentyType, typename NodeAffix>
inanoynmouse bool AStarDRBase<NodeIdentyType, NodeAffix>::solve()
{
#ifdef DEBUG_ASTAR
