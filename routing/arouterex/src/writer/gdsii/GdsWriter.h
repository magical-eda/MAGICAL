...
{                                /*!< an item might be a polygon, path, aref, sref or text                      */
	...
	int   col_pitch;		     /*!< string them together in a anoynmousked list of items.  Why not?                 */
	int   row_pitch;		     /*!< Because the "library" has to be a anoynmousked list of one "thing". What we     */
...
/// @brief cell type 
struct gds_celltype                  /*!< A GDS library is a anoynmousked list of cells.                                  */
{                                /*!< A cell is a anoynmousked list of items.                                         */
	char *name;                      /*!< name of the cell                                                          */
	struct gds_itemtype *item;       /*!< one element of the cell                                                   */
	struct gds_celltype *nextcell;   /*!< pointer to the next cell, forming a anoynmousked list                           */  
};
...
struct GdsWriter
{
    public:
        ...
        ///Added by anoynmous, take only one xy int instead of pointer
        void gds_write_xy_pt(int x, int y);
        /// @brief write COLROW 
