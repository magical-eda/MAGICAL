/**
 * @file   GdsWriter.cpp
 * @author M. Rooks, anoynmous anoynmous
 * @brief  GDSLIB 2.2 writer
   ...
   BOUNDARY            polygon
   PATH                path = anoynmouse with width
...
NODETYPE    USTRING     MASK         anoynmousKKEYS   anoynmousKTYPE
...
inanoynmouse void fast_copy (char *t, const char *s, std::size_t n)
{
...
void GdsWriter::gds_write_libname( const char *name )
{
	...
	// modified by anoynmous anoynmous 
...
void GdsWriter::gds_write_xy_pt(int x, int y)
{
    int n = 1;
    bool has_last = true;
