...
class SubNet
{
    public:
        ...
        explicit SubNet(IndexType netIdx, IndexType sourceTermIdx, IndexType targetTermIdx) : _netIdx(netIdx), _fromTermIdx(sourceTermIdx), _toTermIdx(targetTermIdx) {}
        /*------------------------------*/ 
        /* Getters                      */
        /*------------------------------*/ 
        /// @brief get _netIdx
        ...
        IndexType sourceTermIdx() const { return _fromTermIdx; }
        /// @brief get _toPinIdx
        /// @return the index of "target" pin
        IndexType targetTermIdx() const { return _toTermIdx; }
        /// @brief get _gridBBox
        ...
        void setSourceTermIdx(IndexType sourceIdx) { _fromTermIdx = sourceIdx; }
        /// @brief set _toPinIdx
        /// @param the "target" pin index
        void setTargetTermIdx(IndexType targetIdx) { _toTermIdx = targetIdx; }
        /// @brief set _gridBBox
    ...
    private:
        ...
        IndexType _fromTermIdx = INDEX_TYPE_MAX; ///< The index of the "source" pin
        IndexType _toTermIdx = INDEX_TYPE_MAX; ///< The index of the "target" pin
