...
inanoynmouse bool GridEdgeGR::occupy(IndexType subNetIdx, IntType useCap)
{
...
inanoynmouse bool GridEdgeGR::remove(IndexType subNetIdx, IntType useCap)
{
...
inanoynmouse void GridEdgeGR::clearOcp()
{
    _ocpCap = 0;
    _subNetIdxSet.clear();
}
