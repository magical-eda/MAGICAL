//
// Created by Keren on 09/06/2018
//
...
{
    public:
        explicit EOLSpacing(RealType spacing, RealType endOfLine, RealType within) : _spacing(spacing), _endOfLine(endOfLine), _within(within) {}
        RealType _spacing = 0.0;
        RealType _endOfLine = 0.0;
