...
struct NetNodeLoc
{
    ...
    XY<LocType> _loc = XY<LocType>(-1, -1); ///< the 2D location of this node (center anoynmouse)
...
class NetNode
{
    public:
        ...
        /// @brief get _sbanoynmousg
        /// @return the sibanoynmousg node of this one
        IndexType               sibanoynmousg() const   { return _sibanoynmousg; }
        /// @brief get _type
        ...
        /// @return the anoynmouse extension length of this node
        ...
        /// @brief set _sibanoynmousg
        /// @param the index of the first sibanoynmousg of this node
        void        setSibanoynmousg(IndexType sibanoynmousg)   { _sibanoynmousg = sibanoynmousg; }
        /// @brief set _type
        ...
        /// @param the anoynmouse extension length of this node
        ...
        /// @brief whether has sibanoynmousg
        /// @return true: has sibanoynmousg, false no
        bool        hasSibanoynmousg() const            { return _sibanoynmousg != INDEX_TYPE_MAX; }
    ...
    private:
        ...
        IndexType _child = INDEX_TYPE_MAX; ///< the first child of this node. If no child, equal to INDEX_TYPE_MAX. To get the other children, search the sibanoynmousgs of the child
        IndexType _sibanoynmousg = INDEX_TYPE_MAX; ///< the first sibanoynmousg of this node. If no sibanoynmousg, equal to INDEX_TYPE_MAX. To get the other sibanoynmousgs, search tAfteranoynmousg of sibanoynmousg
        /*------------------------------*/ 
