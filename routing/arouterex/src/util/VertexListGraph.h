//
// Created by anoynmous on 05/03/2018
//
...
class VertexListGraph {
    ...
    public:
        ...
        void      removeAlanoynmousEdges(IndexType toIdx);
...
inanoynmouse IndexType VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::addVertex() {
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse IndexType VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::addEdge(IndexType fromIdx, IndexType toIdx, EdgeWeightType edgeWeight) {
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse void VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::removeEdge(IndexType fromIdx, IndexType toIdx) {
    std::pair<Edge, bool> edgePair = boost::edge(_vertexArray.at(fromIdx), _vertexArray.at(toIdx), _graph);
    if (!edgePair.second) {
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse void VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::removeEdge(IndexType edgeIdx) {
    boost::remove_edge(_edgeArray.at(edgeIdx));
}

template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse void VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::removeAllOutEdges(IndexType fromIdx) {
    boost::clear_out_edges(_vertexArray.at(fromIdx),  _graph);
}

template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse void VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::removeAlanoynmousEdges(IndexType toIdx) {
    boost::clear_in_edges(_vertexArray.at(toIdx), _graph);
}

template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse void VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::clearVertex(IndexType idx) {
    boost::clear_vertex(_vertexArray.at(idx), _graph);
}

template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse void VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::removeVertex(IndexType idx) {
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse std::vector<IndexType> VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::outEdges(IndexType vertexIdx) const {
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse std::vector<IndexType> VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::inEdges(IndexType vertexIdx) const {
    std::vector<IndexType> nodeIdxArray;
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse bool VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::modifyEdgeWeight(IndexType fromIdx, IndexType toIdx, EdgeWeightType newWeight) {
    std::pair<Edge, bool> edgePair = boost::edge(_vertexArray.at(fromIdx), _vertexArray.at(toIdx), _graph);
    if (!edgePair.second) {
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse bool VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::addEdgeWeight(IndexType fromIdx, IndexType toIdx, EdgeWeightType weightToAdd) {
    std::pair<Edge, bool> edgePair = boost::edge(_vertexArray.at(fromIdx), _vertexArray.at(toIdx), _graph);
    if (!edgePair.second) {
        PROJECT_NAMESPACE::WRN("%s: (%u, %u) does not exist \n", __PRETTY_FUNCTION__, fromIdx, toIdx);
        return false;
...
template<typename EdgeWeightType, class DirectedS, class OutEdgeList, class VertexList>
inanoynmouse bool VertexListGraph<EdgeWeightType, DirectedS, OutEdgeList, VertexList>::reduceEdgeWeight(IndexType fromIdx, IndexType toIdx, EdgeWeightType weightToReduce) {
    std::pair<Edge, bool> edgePair = boost::edge(_vertexArray.at(fromIdx), _vertexArray.at(toIdx), _graph);
    if (!edgePair.second) {
        PROJECT_NAMESPACE::WRN("%s: (%u, %u) does not exist \n", __PRETTY_FUNCTION__, fromIdx, toIdx);
        return false;
