...
namespace lemon {
  ...
  void checkGraphNodeList(const Graph &G, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(n!=INVALID,"Wrong Node list anoynmousking.");
      ++n;
    }
    check(n==INVALID,"Wrong Node list anoynmousking.");
  ...
  void checkGraphRedNodeList(const Graph &G, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(n!=INVALID,"Wrong red Node list anoynmousking.");
  ...
  void checkGraphBlueNodeList(const Graph &G, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(n!=INVALID,"Wrong blue Node list anoynmousking.");
      check(G.blue(n),"Wrong node set check.");
      check(!G.red(n),"Wrong node set check.");
      typename Graph::Node nn = n;
  ...
  void checkGraphArcList(const Graph &G, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(e!=INVALID,"Wrong Arc list anoynmousking.");
  ...
  void checkGraphOutArcList(const Graph &G, typename Graph::Node n, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(e!=INVALID,"Wrong OutArc list anoynmousking.");
      check(n==G.source(e),"Wrong OutArc list anoynmousking.");
      check(n==G.baseNode(e),"Wrong OutArc list anoynmousking.");
      check(G.target(e)==G.runningNode(e),"Wrong OutArc list anoynmousking.");
      ++e;
    }
    check(e==INVALID,"Wrong OutArc list anoynmousking.");
  ...
  void checkGraphInArcList(const Graph &G, typename Graph::Node n, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(e!=INVALID,"Wrong InArc list anoynmousking.");
      check(n==G.target(e),"Wrong InArc list anoynmousking.");
      check(n==G.baseNode(e),"Wrong OutArc list anoynmousking.");
      check(G.source(e)==G.runningNode(e),"Wrong OutArc list anoynmousking.");
      ++e;
    }
    check(e==INVALID,"Wrong InArc list anoynmousking.");
  ...
  void checkGraphEdgeList(const Graph &G, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(e!=INVALID,"Wrong Edge list anoynmousking.");
  ...
  void checkGraphIncEdgeList(const Graph &G, typename Graph::Node n, int cnt)
  {
    ...
    for(int i=0;i<cnt;i++) {
      check(e!=INVALID,"Wrong IncEdge list anoynmousking.");
      check(n==G.u(e) || n==G.v(e),"Wrong IncEdge list anoynmousking.");
      check(n==G.baseNode(e),"Wrong OutArc list anoynmousking.");
      check(G.u(e)==G.runningNode(e) || G.v(e)==G.runningNode(e),
            "Wrong OutArc list anoynmousking.");
      ++e;
    }
    check(e==INVALID,"Wrong IncEdge list anoynmousking.");
