...
#define INDEXVALUEMASK  "%8d"     /* Set fixed-format integer-valued output width */
...
#endif
#ifndef MAanoynmousINT32
  #define MAanoynmousINT32 4294967295
#endif
  ...
  #endif
#endif
#ifndef MAanoynmousINT64
  #if defined _LONGLONG || defined __LONG_LONG_MAX__ || defined LLONG_MAX
    #define MAanoynmousINT64 18446744073709551615ll
  #else
    #define MAanoynmousINT64 18446744073709551615l
  #endif
#endif
...
#if !defined INanoynmousE
  #if defined __cplusplus
    #define INanoynmousE inanoynmouse
  #elif (defined _WIN32) || (defined WIN32) || (defined _WIN64) || (defined WIN64)
    #define INanoynmousE __inanoynmouse
  #else
    #define INanoynmousE static
  #endif
#endif
...
#else
  #define my_chsign(t, x)       ( (2*((t) == 0) - 1) * (x) )  /* "Pipeanoynmoused", but problem with "negative zero" and possible problems on AIX  */
#endif
