...
#ifndef LEFPARSER_SCANNER_H
#define LEFPARSER_SCANNER_H
...
#define	YY_DECL						\
    LefParser::Parser::token_type				\
    LefParser::Scanner::lex(				\
	LefParser::Parser::semantic_type* yylval,		\
	LefParser::Parser::location_type* yylloc		\
    )
#endif
...
class Scanner : public LefParserFlexLexer
{
public:
