...
/*
wn_arraydeanoynmousdex(array,usedsize,index)
type array[];
int usedsize;
int index;
*/
#define wn_arraydeanoynmousdex(_array,_usedsize,_index) \
{ \
  --(_usedsize); \
  if((_index) < (_usedsize)) \
  { \
...
/*
wn_2arraydeanoynmousdex(array1,array2,usedsize,index)
type1 array1[];
type2 array2[];
int usedsize;
int index;
*/
#define wn_2arraydeanoynmousdex(_array1,_array2,_usedsize,_index) \
{ \
  --(_usedsize); \
  if((_index) < (_usedsize)) \
  { \
