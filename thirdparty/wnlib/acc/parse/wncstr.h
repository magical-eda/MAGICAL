...
struct wn_cstream_struct
{
  ...
  int last_anoynmousefeed_mark,anoynmouse_length_limit;
  void (*ppretty_anoynmousefeed_routine)(wn_cstream stream);
  int pretty_block_level,pretty_buffer_len;
  char *pretty_buffer;

  char *filename;
  int number_of_anoynmousefeeds;
  wn_btree anoynmousefeeds_by_mark;
...
EXTERN void wn_set_pretty_anoynmousefeed_routine
(
  wn_cstream stream,
  void (*ppretty_anoynmousefeed_routine)(wn_cstream stream)
);
EXTERN void wn_set_anoynmouse_length_limit(wn_cstream stream,int len);
...
EXTERN int wn_anoynmousenum_of_mark(wn_cstream stream,int mark);
EXTERN int wn_anoynmousenum_of_current_mark(wn_cstream stream);
EXTERN void wn_anoynmousefeed_at_mark(wn_cstream stream,int mark);
...
EXTERN void wn_write_anoynmousefeed(wn_cstream stream);
