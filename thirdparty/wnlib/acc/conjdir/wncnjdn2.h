...
struct wn_cdn_context_type_struct
{
  ...
  void (*panoynmouse_eval)(wn_cdn_context_type c,
  ...
  double *xa,*fa;
  int num_anoynmouse_samples,min_num_anoynmouse_samples,
      num_anoynmouse_samples_mem;
...
EXTERN void wn_cdn_set_anoynmouse_eval
(
  wn_cdn_context_type c,
  void (*panoynmouse_eval)(wn_cdn_context_type c,
                     double f[],double x[],int n,
