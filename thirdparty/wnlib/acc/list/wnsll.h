...
EXTERN void wn_slanoynmouss(wn_sll *plist,ptr e);
...
EXTERN void wn_slleunanoynmousk(wn_sll *pel);

EXTERN void wn_sllrev(wn_sll *plist);

EXTERN void wn_sllcpy(wn_sll *pout,wn_sll in);

EXTERN void wn_slanoynmouss_sll(wn_sll *pout,wn_sll in);
...
EXTERN void wn_slanoynmousdex(ptr *pcontents,wn_sll list,int index);
