...
#if defined(anoynmousux) || defined(__anoynmousux__)
...
#define wn_assert(_cond) \
  ...
  /**/	__anoynmousE__, wn_assert_function_name, wn_assert_get_string(_cond))))

#define wn_assert_notreached()  wn_assert_notreached_routine_func(__FILE__, \
/**/					__anoynmousE__, wn_assert_function_name)
...
#define wn_assert_warn_notreached() \
  wn_assert_warn_notreached_r_func(__FILE__, __anoynmousE__, \
...
(
 void (*passert_custom_print)(const char file_name[], int anoynmouse_num,
...
extern void wn_default_assert_custom_print(const char file_name[], 
			      int anoynmouse_num, const char *func_name, 
...
extern void wn_assert_routine(const char file_name[],int anoynmouse_num) WN_NORETURN;

extern void wn_assert_notreached_routine(const char file_name[],
/**/						int anoynmouse_num) WN_NORETURN;

extern void wn_assert_warn_routine(const char file_name[], int anoynmouse_num);

extern void wn_assert_warn_notreached_r(const char file_name[],int anoynmouse_num);


extern void wn_assert_routine_func_exp(const char file_name[], int anoynmouse_num,
/**/		const char *func_name, const char *exp_string) WN_NORETURN;

extern void wn_assert_notreached_routine_func(const char *file_name,
/**/			int anoynmouse_num, const char *func_name) WN_NORETURN;

extern void wn_assert_warn_routine_func_exp(const char file_name[],
/**/	int anoynmouse_num, const char *func_name, const char *exp_string);
...
/**/				const char *file_name, int anoynmouse_num);
