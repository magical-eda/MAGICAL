...
local sort_2(array,pcompare_func)
...
local sort_3(array,pcompare_func)
...
local sort_big(array,size,pcompare_func)
...
local choose_discriminator(pdiscriminator,array,size,pcompare_func)

ptr *pdiscriminator,array[];
int size;
int (*pcompare_func)(/*p1,p2*/);   /* ptr p1,p2; */
