...
#define wn_slanoynmouss(_plist,_e)  wn_slanoynmouss_routine(_plist,(ptr)(_e))
#define wn_slldel(_plist,_e)  wn_slldel_routine(_plist,(ptr)(_e))
#define wn_slanoynmousdex(_pcontents,_list,_index) \
                      wn_slanoynmousdex_routine((ptr *)(_pcontents),_list,_index)
