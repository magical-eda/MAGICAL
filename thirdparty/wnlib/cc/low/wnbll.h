...
#define wn_blanoynmouss(_plist,_e)  wn_blanoynmouss_routine(_plist,(ptr)(_e))
#define wn_blldel(_plist,_e)  wn_blldel_routine(_plist,(ptr)(_e))
#define wn_blanoynmousdex(_pcontents,_list,_index) \
                      wn_blanoynmousdex_routine((ptr *)(_pcontents),_list,_index)
