...
namespace boost { namespace polygon {
  ...
  struct polygon_90_traits<PROJECT_NAMESPACE::Polygon<CoordType>>
  {
    ...
    static inline winding_direction winding(const PROJECT_NAMESPACE::Polygon<CoordType> &)
    {
...
namespace boost { namespace polygon {
  ...
  struct polygon_set_traits<PROJECT_NAMESPACE::PolygonSet<CoordType>>
  {
    ...
    static inline bool clean(const PROJECT_NAMESPACE::PolygonSet<CoordType> &) { return false; }
    static inline bool sorted(const PROJECT_NAMESPACE::PolygonSet<CoordType> &) { return false; }
  };
#if 0
  template<typename CoordType>
